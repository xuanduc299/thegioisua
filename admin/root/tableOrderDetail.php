        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="tableOrderDetail.php" class="nav-item nav-link active"><i class="fas fa-user-check"></i>Orders Detail</a>
                ...
                <div class="row g-4">
                    <div class="col-12">
                        <div class="bg-light rounded h-100 p-4">
                            <h6 class="mb-4">Orders Details Table</h6>
                            <?php include('orderDetail/view_orderDetail.php') ?>
                        </div>
                    </div>
                </div>
            </div>
