    ...
    <div class="wrapper">
        <div id="header">
            <ul id="main-menu">
                ...
                <li><a href="index_order.php" style="background-color: black;">ORDERS</a></li>
                ...
                <div class="col-md-12">
                    <div class="mt-5 mb-3 clearfix">
                        ...
                        <div style="text-align:center;">
                            ...
                            <a href="create_order.php" class="btn btn-success pull-right"><i class="fa fa-plus"></i> Add New Employee</a>
                        </div>
                    </div>
                    <tbody>
                        <?php
                        ...
                        if (isset($_GET['search'])) {
                            ...
                            $query = "SELECT * FROM orders WHERE CONCAT(fullname,phone_number,email,address) LIKE '%$filtervalues%' ";
