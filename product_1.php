...
<body>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-8">
                <img src="./images/design_sua/slide-img10.jpg" alt="" width="100%">
                <div class="product-area section" style="margin-top: -70px;">
                    <div class="container">
                        <p style="font-size: 25px;font-weight: bold;font-family: 'Times New Roman', Times, serif;color: #c05353;margin-bottom: 20px;">Sữa Tiệt Trùng</p>
